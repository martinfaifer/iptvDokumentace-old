                                ...
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn
                                            color="blue darken-1"
                                            text
                                            @click="modalEditFte = false"
                                            >Zavřít</v-btn
                                        >
                                        <v-btn
                                            color="green darken-1"
                                            text
                                            @click="saveBaseEditFte()"
                                            >Uložit</v-btn
                                        >
                                    </v-card-actions>
                                </v-card>
                                ...
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn
                                            color="blue darken-1"
                                            text
                                            @click="modalEditTranscoder = false"
                                            >Zavřít</v-btn
                                        >
                                        <v-btn
                                            color="green darken-1"
                                            text
                                            @click="saveGrapeTranscoder()"
                                            >Uložit</v-btn
                                        >
                                    </v-card-actions>
                                </v-card>
                                ...
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn
                                            color="blue darken-1"
                                            text
                                            @click="modalEditLinux = false"
                                            >Zavřít</v-btn
                                        >
                                        <v-btn
                                            color="green darken-1"
                                            text
                                            @click="saveModalLinux()"
                                            >Uložit</v-btn
                                        >
                                    </v-card-actions>
                                </v-card>
                                ...
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn
                                            color="blue darken-1"
                                            text
                                            @click="modalEditPowerVu = false"
                                            >Zavřít</v-btn
                                        >
                                        <v-btn
                                            color="green darken-1"
                                            text
                                            @click="saveModalPowerVu()"
                                            >Uložit</v-btn
                                        >
                                    </v-card-actions>
                                </v-card>
